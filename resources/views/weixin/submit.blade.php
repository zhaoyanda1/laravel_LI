...
@section('content')
    <div class="type_menu" style="margin-bottom: 20px;">
        <p>
            ...
            名字:<input type="text" name="top_name">
            <button class="top_a">克隆</button>
        </p>
        <div style="margin-bottom: 20px; bottom:5px; class:'top_type' ">
            <button class="top_n">二级按钮</button>
            <button class="top_s">克隆</button>
        </div>
        <div>
            按钮类型：<select name="top_menu">
